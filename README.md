...
```shell
git clone --depth=1 https://e.coding.net/linkeqi1002/rt-n56u/padavan.git /opt/rt-n56u
#git clone --depth=1 https://github.com/linkeqi1002/rt-n56u.git /opt/rt-n56u
```
